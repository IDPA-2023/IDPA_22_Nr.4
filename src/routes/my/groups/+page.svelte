        ...
        <div class="card-body">
            <div class="flex w-full">
                ...
                <div class="w-fit flex ml-auto">
                    <a href="/my/groups/{group.id}/edit" class="btn btn-secondary btn-circle w-12 p-2 ml-auto"><Icon src={Pencil}></Icon></a>
                    <form action="?/deleteGroup" method="post">
                        <input type="hidden" name="groupId" value={group.id}>
                        <button class="btn btn-secondary btn-circle w-12 p-2 ml-2"><Icon src={Trash}></Icon></button>
                    </form>
                </div>
            </div>
        </div>
